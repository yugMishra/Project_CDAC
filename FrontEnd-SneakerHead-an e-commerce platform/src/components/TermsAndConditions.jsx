  ...
  return (
    ...
    <br /><br /><br />
      ...
      <Container className="mt-3">
        <Row>
          <Col lg={6}>
            <b>TERMS & CONDITIONS </b> <p>Welcome to sneakerhead.in!</p>
            <p>
              These terms and conditions outline the rules and regulations for
              the use of MDB international's Website, located at sneakerhead.in{" "}
            </p>
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use thrifter.in if you do not agree
              to take all of the terms and conditions stated on this page.
            </p>
            <p>
              <b>Cookies</b>
              <br></br>
              <br></br> "The Company", "Ourselves", "We", "Our" and "Us", refers
              ...
              accessing thrifter.in, you agreed to use cookies in agreement with
              the MDB international's Privacy Policy. Most interactive websites
            ...
            <p>
              ...
              other listed businesses; and Systemwide Accredited Businesses
              ...
              our Web site. These organizations may link to our home page, to
              publications or to other Website information so long as the link:
              <br></br>
              (a) is not in any way deceptive; <br></br>
              (b) does not falsely imply sponsorship, endorsement or approval of
              the linking party and its products and/or services; and <br></br>
